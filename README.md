...
*PB* - Sends notifications to the PushBullet API (see dependancies)
...
The config requirements for pushbullet are located inside the python script itself 	(plugin-examples\pb.py)
...
To use the PB Plugin you need to install the Pushbullet library
